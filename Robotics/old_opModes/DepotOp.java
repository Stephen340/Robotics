...
@Disabled
@Autonomous (name = "DepotOp", group= "Linear Opmode")

public class DepotOp extends LinearOpMode {
    ...
    public void first_path() {
        move_forward_rev(2.6, 0.8);
        turn_right_rev(1, 0.8);
        move_forward_rev(2.7, 0.8);
        claim();
        move_forward_rev(-7.7, 0.8);
    }

    public void second_path() {
        move_forward_rev(3.8, 1);
        turn_right_rev(0.7, 1);
        claim();
    ...
    public void third_path() {
        ...
        turn_left_rev(1, 1);
        move_forward_rev(2, 1);
        turn_right_rev(1.5, 1);
        claim();
        move_forward_rev(-1.2, 1);
        turn_left_rev(0.2, 1);
        move_forward_rev(-0.5, 1);
        turn_left_rev(0.2, 1);
        move_forward_rev(-5, 1);
    }
    ...
    public void runOpMode() {
        ...
        if (opModeIsActive()) {
            unlatch();
            move_forward_rev(-1.2, 0.8);
            turn_right_rev(1.6, 1);
            int goldPlace = -1;
